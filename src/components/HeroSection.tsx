...
const HeroSection = () => {
  return (
    <section className="flex items-center justify-center px-1 md:px-2 pt-20 md:pt-24 pb-8 md:pb-12 bg-gradient-to-br from-stone-50 to-stone-100/80">
      <div className="max-w-4xl mx-auto text-center">
        <div className="bg-white/60 backdrop-blur-sm rounded-3xl p-6 md:p-8 lg:p-10 shadow-soft border border-stone-200/50">
