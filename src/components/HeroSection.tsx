...
const HeroSection = () => {
  return <section className="min-h-screen flex items-center justify-center px-2 md:px-4 pt-16 md:pt-20 pb-4 md:pb-6 bg-gradient-to-br from-stone-50 to-stone-100/80 py-[40px]">
