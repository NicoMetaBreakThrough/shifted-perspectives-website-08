    ...
    <section className="py-24 px-8 bg-stone-100/40">
      <div className="max-w-4xl mx-auto">
        <div className="bg-white/70 backdrop-blur-sm rounded-3xl p-12 md:p-16 shadow-gentle border border-stone-200/50">
          <h2 className="text-4xl md:text-5xl font-playfair font-medium text-stone-800 mb-16 text-center tracking-tight">
            A Private Space for Real Change
          </h2>
          
          <div className="grid md:grid-cols-2 gap-12">
            <div className="space-y-6">
              <h3 className="text-2xl font-playfair font-medium text-stone-800 mb-8 tracking-wide">
                What This Is
              </h3>
              <div className="space-y-4 text-lg text-stone-700 prose-custom">
